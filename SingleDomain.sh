...
rm -rf report.txt
rm -rf results.csv
domain="https://go.boardbooks.com/"
#echo "$domain"
curl --url 'https://www.virustotal.com/vtapi/v2/url/report?apikey=d7cabc7be1d9d9f4ed2e1c74aa66cb24c1cab8e90b61595c04e32b996b25867c&resource=https://go.boardbooks.com/' >> report.txt
